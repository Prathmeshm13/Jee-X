...
export const INK = '#202126'
export const INK_2 = '#5F6069'
export const INK_3 = '#71727C'
export const PAGE = '#F5F5F7'
export const LINE = '#DFDFE5'
export const WHITE = '#FFFFFF'

export const PEN = '#BA431F'
export const GOOD = '#4264BC'
export const BAD = '#E5484D'
export const MARKED = '#7B4FD8'
export const IDLE = '#D9DEE8'

export const PHYSICS = '#536BC3'
export const CHEM = '#AD622D'
export const MATHS = '#786BB1'

export const SUBJECT_COLOR = { Physics: PHYSICS, Chemistry: CHEM, Mathematics: MATHS, PHY: PHYSICS, CHEM, MATH: MATHS }

export const fontBody = "'DM Sans', 'Segoe UI', system-ui, sans-serif"
...
export const input = { width: '100%', height: 48, padding: '0 14px', fontSize: 15.5, border: `1px solid ${'#CBCBD3'}`, borderRadius: 10, background: WHITE, color: INK, fontFamily: fontBody }
...
export const ghostBtn = { ...primaryBtn, background: WHITE, color: INK, border: '1px solid #CBCBD3' }
